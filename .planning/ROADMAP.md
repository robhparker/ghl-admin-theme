...
- [ ] 01-01-PLAN.md — Walking skeleton: config -> context -> Send Invite -> stubbed webhook -> queued, plus harness and stylesheet
...
- [ ] 01-03-PLAN.md — Header buttons, location overrides, action allowlist and handler registry, scoped observers, verify mode, disabled/no-op paths
...
|-------|----------------|--------|-----------|
| 1. Foundation, Context & Workflow Buttons | 0/3 | Not started | - |
